...
trainset = Fakeddit("multimodal_only_samples/multimodal_train.tsv","public_images.tar2.bz2 ") 
trainloader = torch.utils.data.Dataloader(
    trainset,batch_size=128, shuffle=True, num_workers=2
)

testset = Fakeddit("multimodal_only_samples/multimodal_test.tsv","public_images.tar.bz2")
